...
(<!--count:tests-->445 tests, oracle present), all <!--count:checks-->eighteen repository checks pass,
...
**P12 — The original as a build and test dependency.** <!--count:origin-markers-->4,142 `6502:`
