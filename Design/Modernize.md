...
caught or a proved equivalent (plan §6.156). The suite is <!--count:tests-->152 tests now, and
...
`Outpost/Main.cpp` is <!--count:main-lines-->258 lines and every one of them is the platform: the
