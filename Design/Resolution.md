...
<!--count:checks-->15 repository checks passing, and what it decided is
...
<!--count:checks-->15 repository checks pass. The canvas is untouched: every oracle comparison,
...
the oracle present, and all <!--count:checks-->fifteen repository checks pass — two of them new.
...
oracle present, and all <!--count:checks-->fifteen repository checks pass.
