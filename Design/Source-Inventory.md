...
| `mt1`, `mt2`, `mt5`, `mt6`, `mt8`, `mt9`, `mt13`, `mt14`, `mt15`, `mt16`, `mt17`, `mt18`, `mt19`, `mt26`, `mt27`, `mt28`, `vowel`, `whitetext`, `rline` | 19 | `ExtendedTokens.cpp` | Port — reached through the control-code seam, which exists and is tested. Most move the cursor or clear the screen, so they land with the canvas (slice 1c-c). `mt26`/`rline` take their characters from `InputFrame`. |
| ✅ `mtin` | 1 | `ExtendedTokenTables.cpp` | **Extracted 2026-09-03**, byte-compared against the oracle image. |
| `dtw1`–`dtw6`, `dtw8`, `feed`, `dtw*` justification state | 8 | `TextPrint.cpp` | Port |
| `tt26`, `tt26-chpr`, `chpr2`, `tt67`, `tt67-tt67k`, `tt69`, `ttx69`, `tt70`, `tt60`, `tt146`, `tt11`, `bprnt`, `pr2`, `pr5`, `pr6`, `prq`, `tens`, `tnpr`, `tnpr1`, `setxc`, `setxc-doxc`, `setyc`, `setyc-doyc`, `incyc`, `clss`, `rr4s`, `r5`, `wscan`, `newosrdch`, `setvdu19-dovdu19`, `docol`, `dohfx`, `dosvn` | 33 | `TextPrint.cpp`, `Canvas.cpp` | Port (`wscan` — wait for raster — is a no-op; `setvdu19` — palette change — becomes a canvas palette-slot write) |
| `pdesc`, `cpl`, `cmn`, `ypl`, `tal`, `fwl`, `tt24`, `tt25`, `tt22`, `tt23`, `tt15`, `tt14`, `tt128`, `tt16`, `tt103`, `tt123`, `tt105`, `tt81`, `tt111`, `tt147`, `tt151`, `tt152`, `tt167`, `tt213`, `tt214`, `tt219`, `tt210`, `tt208`, `gnum`, `nwdav4`, `tt217`, `var`, `gvl`, `status`, `plf2`, `eqshp`, `dn`, `dn2`, `eq`, `prx`, `prxs`, `qv`, `hm`, `refund`, `lcash`, `mcash`, `gcash`, `gc2`, `rdli`, `tt17`, `yesno`, `trademode`, `qq23`, `item`, `ex`, `tt20`, `tt54`, `hyp`, `hyp1`, `hy6-docked`, `ww`, `ttx110`, `ghy`, `jmp`, `ee3`, `tt66`, `ttx66-ttx66k`, `ttx66k`, `tt66simp`, `box2`, `boxs`, `boxs2`, `blueband`, `bluebands`, `wantdials`, `zonkscanners`, `nosprites`, `setl1`, `l1m`, `clyns`, `zes1k`, `zes2k`, `zesnew`, `zes1`, `zes2`, `zero`, `zebc` | 86 | `Universe.cpp`, `SystemData.cpp`, `Charts.cpp`, `Market.cpp`, `Equipment.cpp`, `Screens.cpp`, `StatusScreen.cpp`, `MarketScreen.cpp`, `ChartScreens.cpp`, `Hyperspace.cpp`, `Canvas.cpp` | Port. `nosprites`/`wantdials`/`zonkscanners`/`blueband` (VIC-II sprite and raster-split control when switching between the space view and a text screen) become canvas-mode flags with the same visible effect. |
