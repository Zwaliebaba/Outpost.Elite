...
| `cmn`, `ypl`, `fwl`, `tt25`, `tt81`, `tt111`, `tt151`, `tt152`, `tt167`, `tt213`, `tt214`, `tt219`, `tt210`, `tt208`, `gnum`, `nwdav4`, `tt217`, `var`, `gvl`, `status`, `plf2`, `eqshp`, `dn`, `dn2`, `eq`, `prx`, `prxs`, `qv`, `hm`, `refund`, `rdli`, `tt17`, `yesno`, `trademode`, `qq23`, `item`, `ex`, `tt20`, `tt54`, `hyp`, `hyp1`, `hy6-docked`, `ww`, `ghy`, `jmp`, `ee3`, `tt66`, `ttx66-ttx66k`, `ttx66k`, `tt66simp`, `box2`, `boxs`, `boxs2`, `blueband`, `bluebands`, `wantdials`, `zonkscanners`, `nosprites`, `setl1`, `l1m`, `clyns`, `zes1k`, `zes2k`, `zesnew`, `zes1`, `zes2`, `zero`, `zebc` | 63 | `Universe.cpp`, `SystemData.cpp`, `Charts.cpp`, `Market.cpp`, `Equipment.cpp`, `Screens.cpp`, `StatusScreen.cpp`, `MarketScreen.cpp`, `ChartScreens.cpp`, `Hyperspace.cpp`, `Canvas.cpp` | Port. `nosprites`/`wantdials`/`zonkscanners`/`blueband` (VIC-II sprite and raster-split control when switching between the space view and a text screen) become canvas-mode flags with the same visible effect. |
