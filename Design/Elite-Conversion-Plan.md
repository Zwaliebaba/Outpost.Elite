...
- `Outpost/` — the executable: a raw Win32 window, a D3D12 flip-model presenter for the indexed
  ...
  composition root in `Main.cpp` of <!--count:main-lines-->240 lines that builds `Elite::Game`
...
- `Tests/GameLogicTests/` — <!--count:tests-->404 tests in <!--count:test-files-->56 files: the 6502 interpreter with its cycle counter,
