...
**Phase 1 is closed.** 1c-c-b built 2026-09-03: eighteen of the twenty-one extended control codes
...
| 2026-09-03 | **Slice 1c-c-b built, and phase 1 is closed.** Eighteen of the twenty-one extended control codes, `DASC`, and the justification line buffer. `PDESC`'s 2,048 descriptions now compare character for character, which unblocks the last of slice 2a. Six of the nine codes the scoping note called blocked were not: §6.12 records the mirror image of the ledger problem — a dependency graph read too pessimistically. |
