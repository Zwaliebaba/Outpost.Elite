...
- `GameLogic/` — **the port**, namespace `Elite`: <!--count:gamelogic-sources-->68 translation units and <!--count:gamelogic-headers-->63 headers,
...
- `Outpost/` — the executable: a raw Win32 window, a D3D12 flip-model presenter for the indexed
  ...
  composition root in `Main.cpp` of <!--count:main-lines-->243 lines that builds `Elite::Game`
...
- `Tests/GameLogicTests/` — <!--count:tests-->408 tests in <!--count:test-files-->56 files: the 6502 interpreter with its cycle counter,
...
<!--count:gamelogic-sources-->68 sources and <!--count:gamelogic-headers-->63 headers. The three
