...
- `GameLogic/` — **the port**, namespace `Elite`: <!--count:gamelogic-sources-->71 translation units and <!--count:gamelogic-headers-->65 headers,
...
- `Tests/GameLogicTests/` — <!--count:tests-->419 tests in <!--count:test-files-->58 files: the 6502 interpreter with its cycle counter,
...
<!--count:gamelogic-sources-->71 sources and <!--count:gamelogic-headers-->65 headers. The three
