...
- `GameLogic/` — **the port**, namespace `Elite`: <!--count:gamelogic-sources-->68 translation units and <!--count:gamelogic-headers-->62 headers,
...
- `Outpost/` — the executable: a raw Win32 window, a D3D12 flip-model presenter for the indexed
  ...
  docks and dies.
- `Tests/GameLogicTests/` — <!--count:tests-->402 tests in <!--count:test-files-->57 files: the 6502 interpreter with its cycle counter and
...
<!--count:gamelogic-sources-->68 sources and <!--count:gamelogic-headers-->62 headers. The three
