...
- `GameLogic/` — **the port**, namespace `Elite`: <!--count:gamelogic-sources-->66 translation units and <!--count:gamelogic-headers-->59 headers,
...
- `Outpost/` — the executable: a raw Win32 window, a D3D12 flip-model presenter for the indexed
  ...
  docks and dies.
- `Tests/GameLogicTests/` — <!--count:tests-->397 tests in <!--count:test-files-->56 files: the 6502 interpreter with its cycle counter and
...
- `tools/` — the label map and table extractors, `c64_source.py`, and the
  <!--count:checks-->fourteen repository checks CI runs on every push, of <!--count:tools-->15 scripts
  in the folder.
...
<!--count:gamelogic-sources-->66 sources and <!--count:gamelogic-headers-->59 headers. The three
