...
- `GameLogic/` — **the port**, namespace `Elite`: <!--count:gamelogic-sources-->66 translation units and <!--count:gamelogic-headers-->56 headers,
...
<!--count:gamelogic-sources-->66 sources and <!--count:gamelogic-headers-->56 headers. The three
