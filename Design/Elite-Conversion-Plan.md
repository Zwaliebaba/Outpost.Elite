...
- `GameLogic/` — **the port**, namespace `Elite`: <!--count:gamelogic-sources-->67 translation units and <!--count:gamelogic-headers-->60 headers,
...
<!--count:gamelogic-sources-->67 sources and <!--count:gamelogic-headers-->60 headers. The three
