...
- `GameLogic/` — **the port**, namespace `Elite`: <!--count:gamelogic-sources-->66 translation units and <!--count:gamelogic-headers-->55 headers,
...
- `Outpost/` — the executable: a raw Win32 window, a D3D12 flip-model presenter for the indexed
  ...
  docks and dies.
- `Tests/GameLogicTests/` — <!--count:tests-->392 tests in <!--count:test-files-->56 files: the 6502 interpreter with its cycle counter and
...
<!--count:gamelogic-sources-->66 sources and <!--count:gamelogic-headers-->55 headers. The three
