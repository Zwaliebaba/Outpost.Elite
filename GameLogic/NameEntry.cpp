...
LineResult ReadLine(KeySource& _keys, TextSink& _screen, TextState& _text, LineEntryEffects& _effects,
...
void StoreCommanderName(std::span<std::uint8_t> _buffer,
...
void LoadCommanderName(std::span<const std::uint8_t, COMMANDER_NAME_SIZE> _name,
                       std::span<std::uint8_t> _buffer) noexcept
{
...
LineResult AskCommanderName(KeySource& _keys, TextSink& _screen, TextState& _text,
                            ExtendedTokenPrinter& _extended, LineEntryEffects& _effects,
                            std::span<std::uint8_t> _buffer,
                            std::span<const std::uint8_t, COMMANDER_NAME_SIZE> _name,
