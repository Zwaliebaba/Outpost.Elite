...
namespace Elite
{
   ...
   *
   * EQSHP, with prx, qv, eq and refund. A list of what this station sells, a number typed in,
   * and a chain of thirteen comparisons that fits whatever was bought.
   */

  /// PRXS has fourteen entries -- the twelve the cassette version sells plus the military and
  /// mining lasers the C64 build adds.
  inline constexpr int EQUIPMENT_ITEM_COUNT = 14;

  /*
   * The price of one item, in tenths of a credit.
   *
  ...
  /*
   * The fuel price, computed at the top of `EQSHP` -- 70 minus the tank, doubled, stored
  ...
  /*
   * The four-view menu, and which one the player picks.
   *
  ...
  /*
   * Fit a laser, and give back what the old one cost.
   *
