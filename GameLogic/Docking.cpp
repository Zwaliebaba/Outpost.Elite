...
namespace Elite
{
  ...
  namespace
  {
     ...
     *
     * The cash test is the one worth stopping on. `CASH` is FOUR bytes, most significant first,
     * holding tenths of a credit -- and this reads the third of them and ignores the two above it.
     * So the test is not "have you got 5017.6 credits": it is whether bits 8 to 15 of the tenths
