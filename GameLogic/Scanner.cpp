...
void DrawScannerBlip(Canvas& _canvas, DrawWorkspace& _work, const ShipBlock& _ship,
                     std::uint8_t _type, std::uint8_t _view) noexcept
{
  ...
  const std::uint8_t ground =
    static_cast<std::uint8_t>(AddWithCarry(depth, 83u, depthCarry).value ^ 0xFFu);
...
void LoadPlanetAxes(const Bubble& _bubble, CompassAxes& _axes, DrawWorkspace& _work,
...
void LoadStationAxes(const Bubble& _bubble, CompassAxes& _axes, DrawWorkspace& _work,
                     MathWorkspace& _math) noexcept
{
...
void DrawCompass(Canvas& _canvas, DrawWorkspace& _work, MathWorkspace& _math,
                 Compass& _compass) noexcept
{
  /*
...
void AimCompassAtStation(Canvas& _canvas, DrawWorkspace& _work, MathWorkspace& _math,
                         Compass& _compass, const Bubble& _bubble, CompassAxes& _axes) noexcept
{
...
void UpdateCompass(Canvas& _canvas, DrawWorkspace& _work, MathWorkspace& _math, Compass& _compass,
