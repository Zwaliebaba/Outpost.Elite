 ...
 *
 * `LDA QQ20+3 / CLC / ADC QQ20+6 / ASL A / ADC QQ20+10`: slaves and narcotics together, DOUBLED,
 * and then firearms at face value. So a tonne of slaves costs twice what a tonne of firearms
 * does, and the doubling is a shift of the sum rather than two multiplications -- which also
 * means it wraps at 128 rather than saturating, and a hold with 128 tonnes of narcotics in it
 * would come out innocent. The hold cannot carry that much, so the wrap is unreachable.
 *
