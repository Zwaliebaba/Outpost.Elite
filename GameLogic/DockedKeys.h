...
[[nodiscard]] constexpr bool IsChartView(std::uint8_t _view) noexcept { return (_view & 0xC0u) != 0u; }
 ...
 */
[[nodiscard]] KeyOutcome ActionForKey(std::uint8_t _key, std::uint8_t _dockedFlag, std::uint8_t _view,
