...
public:
   ...
   */
  [[nodiscard]] virtual std::uint8_t ShowTitleScreen(std::uint8_t _token, std::uint8_t _shipType,
                                                     std::uint8_t _distance) = 0;
};
 ...
 */
[[nodiscard]] ForcedKey ForceKey(std::uint8_t _key, std::uint8_t _dockedFlag, std::uint8_t _view,
 ...
 */
[[nodiscard]] ForcedKey EnterDockingBay(std::uint8_t& _dockedFlag, std::uint8_t _view,
                                        std::uint8_t _countdown, bool _hyperspaceHeld) noexcept;
